...
public interface ExportAddOn {
	 ...
	 */
	public void export(GTDModel model, ActionsCollection collection, OutputStream out, ExportOrder order, FileFilter fileFilter, boolean compact) throws Exception;
